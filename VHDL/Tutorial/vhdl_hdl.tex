...
\begin{abstract}
  ...
  using at least one programming language such as C/C++.
...
\lstinputlisting[language=vhdl, firstline=7
...
\paragraph{Structural architecture}
  ...
  , firstline=27, lastline=74]{../GHDLDemo/demo.vhd}
  ...
  component is connected to which component. Threfore much is known about the
  ...
  maturity of synthesis tools \footnote{Conversion of a description to the
  netlist of the hardware is known as synthesis.} 
  Fortunately for us, we are not concerned about synthesis in this course.
  Anyway lets have a look at the hardware is generated by Xilinx tool.
