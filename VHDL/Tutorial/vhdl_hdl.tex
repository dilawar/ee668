...
\paragraph{Structural architecture}
  ...
  Structural code specify the hardware components and no intelligence is
  required to produce any hardware. But how to convert a behavioural description
  to hardware? It is not always easy and tools available in market relies on
  heuristics. Let's see what sort of hardware is generated by Xilinx tool.
